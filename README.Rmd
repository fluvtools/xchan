...
vignette][basic-channels] and [Channels with Profiles
vignette][profiles-vignette] for more information.

[basic-channels]: https://fluvtools.github.io/xchan/articles/basic_channels.html
[profiles-vignette]: https://fluvtools.github.io/xchan/articles/channels_with_profiles.html
...
by sampling the DEM at each planimetric cross section (`sample_freq =
10` m). The packaged Squamish DEM is LiDAR-derived and does not include
submerged bathymetry, so the sampled profiles show a flat water surface
rather than a channel. We insert a synthetic rectangular channel 3 m
deep with `xt_dredge_to()`.
...
Computations vignette][channel-computations].

[channel-computations]: https://fluvtools.github.io/xchan/articles/channel_computations.html
