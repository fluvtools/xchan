...
Squamish_dem <- terra::unwrap(Squamish_dem)
```
...
``` r
planimetric_cross_sections <- xt_generate_plan(Squamish_bankline, spacing = 200)
...
example, the channel is widened by 150 metres on the right bank:
